...
FROM PELICULA
WHERE duracion > 120
  AND anyo BETWEEN 1980 AND 1989 5. Obtener  el  código  y  el  título  de  las  películas  que  estén  basadas  en  algún  libro  y  cuyo director se apellide ‘Pakula’.
...
FROM PELICULA
WHERE duracion > 120
  AND anyo BETWEEN 1980 AND 1989 7. ¿Cuántas películas se han clasificado de los géneros de código 'BB5' o 'GG4' o'JH6'?

SELECT COUNT(cod_peli)
FROM CLASIFICACION
WHERE cod_gen = 'BB5'
  AND cod_gen = 'GG4'
  AND cod_gen = 'JH6' 8. ¿De que año es el libro más antiguo?

SELECT MIN(anyo)
FROM LIBRO 9. ¿Cuál es la duración media de las películas del año 1987?

SELECT AVG(duracion)
FROM PELICULA
WHERE anyo = 1987 10. ¿Cuántos minutos ocupan todas las películas dirigidas por ‘Steven Spielberg’?
...
FROM PELICULA P,
     LIBRO L
WHERE L.anyo < 1950
  AND P.cod_lib = L.cod_lib 4. Obtener  el  código  y  el  nombre  de  los  países  de  los  actores  que  actúan  en  películas clasificadas del género de nombre ‘Comedia’ (ordenados por nombre).
